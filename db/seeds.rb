...
austin = Player.create(name: "Austin Evans", age: 28, position:"Right Wing", avg_num_points: 22.0, team: team1)
...
ben = Player.create(name: "Ben Rowe", age: 23, position: "Right Wing", avg_num_points: 21.8, team: team2)
...
haley = Player.create(name: "Haley Raley", age: 23, position: "Right Wing", avg_num_points: 21.9, team: team3)
...
david = Player.create(name: "David Fertitta", age: 32, position: "Left Wing", avg_num_points: 21.8, team: team4)
